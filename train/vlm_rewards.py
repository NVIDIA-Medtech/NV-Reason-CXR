...
class CX:
    ...
    def get_list():
        return [CX.Atelectasis, CX.Cardiomegaly, CX.Consolidation, CX.Edema, CX.Enlarged_Cardiomediastinum, CX.Fracture, CX.Lung_Lesion, CX.Lung_Opacity, CX.No_Finding, CX.Pleural_Effusion, CX.Pleural_Other, CX.Pneumonia, CX.Pneumothorax, CX.Support_Devices]
